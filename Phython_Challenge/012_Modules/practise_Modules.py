...
# main.py file
#import mymodule
#print(mymodule.generate_full_name('Muyiwa', 'Oladimeji')) #
...
# different parts of the Python runtime environment. Function sys.argv returns a list of command line arguments passed to a Python script. The item at index 0 in this list is always the name of the script, at index 1 is the argument passed from the command line.
...
# python script.py MUYIWA 30DaysOfPython
# The result:
# Welcome Muyiwa. Enjoy  30DayOfPython challenge! Some useful sys commands:
# to exit sys
sys.exit()
...
#Now, we have imported the math module which contains
# lots of function which can help us to perform mathematical calculations.
...
#Random Module
#By now you are familiar with importing modules.
# Let us do one more import to get very familiar with it. Let us import random module which gives us a random number between 0 and 0.9999.... The random module has lots of functions but in this section we will only use random and randint.
